...
final class Version20220307080545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, us_username VARCHAR(50) NOT NULL, us_password LONGTEXT NOT NULL, us_fullname VARCHAR(50) NOT NULL, us_mail VARCHAR(50) DEFAULT NULL, us_phone VARCHAR(12) NOT NULL, us_address LONGTEXT NOT NULL, us_role VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
